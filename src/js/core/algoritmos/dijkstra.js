...
(function() {
    ...
    var Dijkstra = function() {
        if (Grafo.Direcionado) {
            lnConsole.message('Desculpe, mas Dijkstra ainda n�o foi implementado para grafos direcionados!');
            return 0;
        }
        lnConsole.message('Inicio do algoritmo de Dijkstra.');
        ...
        while(Q.length > 0) {
            ...
            lnConsole.message('Menor aresta: ' +Q[PosMenor].index +'.',
