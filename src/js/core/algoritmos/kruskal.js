...
(function(){
    ...
    var Kruskal = function() {
        ...
        if(Grafo.Direcionado) {
            lnConsole.message('Kruskal ainda n�o foi implementado para grafos direcionados!');
            return 0;
        }
        lnConsole.message('Inicio do algoritmo de Kruskal');
        ...
        while(numAresColocadas < numVertices -1 || lsAresPrioridade.length) {
            ...
            lnConsole.message('Menor aresta encontrada: [' +arestaAtual.v1 +'] - [' +arestaAtual.v2 +']');
